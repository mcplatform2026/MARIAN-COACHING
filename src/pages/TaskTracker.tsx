          ...
          <form onSubmit={handleAddTask} className="relative flex-1 w-full flex flex-col md:flex-row gap-3 md:items-center">
            ...
            <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
              ...
              <button
                type="submit"
                disabled={isAdding}
                className="appearance-none rounded-none w-full md:w-auto h-[52px] md:h-9 px-4 text-white font-headline font-bold uppercase tracking-wider text-xs border-2 border-black transition-all disabled:opacity-50 flex items-center justify-center gap-1.5 shrink-0 hover:opacity-90 active:translate-y-0.5 neu-shadow-sm cursor-pointer"
