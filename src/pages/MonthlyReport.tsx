...
export function MonthlyReport() {
  ...
  const handleDownloadPDF = async () => {
    const element = reportRef.current || document.getElementById("monthly-report-capture-area");
    if (!element) return;

    setDownloading(true);
    const monthName = typeof selectedMonth !== 'undefined' ? MONTHS[selectedMonth] : 'Month';
