...
// Themes definition from Invoices.tsx
...
export function InvoiceView() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      styles.forEach(s => iframeDoc.head.appendChild(s.cloneNode(true)));
      ...
      pdf.save("invoice_" + invoiceNoStr + ".pdf");
  ...
  return (
    <div className="min-h-screen bg-neutral-100 font-body flex flex-col items-center">
      ...
      {/* Top Action Bar */}
      <div className="w-full bg-white border-b-2 border-black p-4 sticky top-0 z-50 shadow-sm flex items-center justify-between lg:px-12">
        ...
        <button 
          ...
          className="px-4 py-2 bg-blue-600 text-white font-headline font-bold text-xs uppercase tracking-widest border-2 border-black flex items-center gap-2 hover:bg-blue-700 transition-colors disabled:opacity-50"
        >
        ...
        >
          ...
          <div className="flex justify-between items-start mb-12">
            <div className="flex-1">
              {invoice.logoImage ? (
                <img src={invoice.logoImage} alt="Brand Logo" className="h-16 w-auto object-contain mb-4" />
              ) : (
          ...
          {/* Footer */}
          <div className="mt-16 pt-8 border-t-2 flex flex-col items-center" style={{ borderColor: borderCol }}>
            ...
            <div className="flex flex-col items-center gap-1 mb-10 w-full max-w-[280px]">
              <div className="w-full flex justify-center mb-1 h-14 relative">
                {invoice.signatureImage ? (
                  ...
                  <span className={"text-3xl text-neutral-800 -rotate-2 " + (invoice.signatureFontClass || 'font-writing-1')} style={{ fontFamily: 'var(--font-headline-family)' }}>
                    {invoice.signatureWritten}
                  </span>
                ) : null}
              </div>
            ...
            <div id="footer-contact-row" className="flex flex-row items-center justify-center gap-6 w-full max-w-[500px] mx-auto font-bold font-headline uppercase tracking-wide text-[10px] opacity-60">
...
console.log('Rewrote InvoiceView');
